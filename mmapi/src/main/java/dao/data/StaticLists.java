...
public class StaticLists {
    ...
    public static final List<Character> characters = new ArrayList<>(List.of(
            new Character(1, "Hannibal Lecter", new ArrayList<>(List.of("Psychiatrist", "Cannibal")), false,"","", 1),
            new Character(2, "Le Chiffre", new ArrayList<>(List.of("Terrorist", "Poker gambler")), false,"", "", 2),
            new Character(3, "Cliff Unger", new ArrayList<>(List.of("Captain", "EV")), false, "", "", 3)
    ));
